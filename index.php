        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="index.php?page=data_penjualan_multi"><i class="glyphicon glyphicon-tags"></i> <span>Data Penjualan Multi</span></a></li>
              </ul>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="index.php?page=transaksi_barang"><i class="glyphicon glyphicon-tags"></i> <span>Single Item</span></a></li>
              </ul>
              <ul class="treeview-menu">
                <li><a href="index.php?page=data_multibarang"><i class="glyphicon glyphicon-tags"></i> <span>Multi Item</span></a></li>
              </ul>
            </li>
